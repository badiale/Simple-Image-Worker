...
public class Harris {
	...
	public Harris (double sigma, double alfa, int size) {
		this.sigma = sigma;
		this.alfa = alfa;
		this.size = size;
	...
	public Harris (double sigma, double alfa, int size, boolean showResults) {
		this(sigma, alfa, size);
	...
	public static void main(String[] args) throws Exception {
		...
		Harris h = new Harris(1.44, 0.04, 5);
		h.execute(lena);
		h.execute(cameraman);
