...
public class Subtract implements BinaryMatrixOperations {
	...
	public ComplexNumber[][] execute(ComplexNumber[][] a, double scalar) {
		...
		for (int y = 0; y < height; y++)
			for (int x = 0; x < width; x++) {
				c[y][x] = new ComplexNumber(a[y][x]);
				c[y][x].subtract(new ComplexNumber(scalar, 0));
			}
	...
	public static void main (String[] args) {
		...
		BinaryMatrixOperations op = new Subtract();
